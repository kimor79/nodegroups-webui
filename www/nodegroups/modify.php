 ...
 <div class="yui-u first wui-boxa">
  <form id="modify-nodegroup" method="POST" action="<?php echo $api_uri; ?>/v2/w/modify_nodegroup.php?outputFormat=json">
   <table>
    ...
    <tr>
     <td>
      <textarea name="description"><?php $wui->showHTMLValue($details['description']); ?></textarea>
     </td>
    </tr>
    <tr>
    ...
    <tr>
     <td>
      <textarea name="expression"><?php $wui->showHTMLValue($details['expression']); ?></textarea>
     </td>
    </tr>
   </table>
   <div class="align-right">
    ...
    <a href="<?php $wui->showSelfURN('/nodegroups/details.php?nodegroup=' . urlencode($details['nodegroup'])); ?>" class="a-button cancel">
